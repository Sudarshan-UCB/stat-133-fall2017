...
-   an index greater than the length of the vector: `four[5]`? NA<br> We always get a "NA" as an answer.

-   repeated indices: `four[c(1,2,2,3,3,3)]`? Al Horford, Amir Johnson, Amir Johnson, Avery Bradley, Avery Bradley, Avery Bradley The value of the index is used everytime an index is encountered. Repeated indices results in repeated value.
